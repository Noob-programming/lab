...
namespace lab.customerTableAdapters {
...
SELECT Guest_id, FirstName, SureName, LastName, Date_of_Birth, Gender, Pnumber, City, Id_identity FROM Guest WHERE (Id_identity = @Id_identity)";
        ...
        public virtual int Fill(customer.GuestDataTable dataTable) {
        ...
        public virtual customer.GuestDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            customer.GuestDataTable dataTable = new customer.GuestDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(customer.GuestDataTable dataTable) {
