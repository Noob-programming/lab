...
namespace lab.HotelDataSet1TableAdapters {
...
SELECT Enumber, Fname, Surename, Lastname, SSN, Salary, Job, Address, Age, PNumber, Gender FROM Office WHERE (SSN = @SSN)";
        ...
        public virtual int Fill(HotelDataSet1.OfficeDataTable dataTable) {
        ...
        public virtual HotelDataSet1.OfficeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelDataSet1.OfficeDataTable dataTable = new HotelDataSet1.OfficeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelDataSet1.OfficeDataTable dataTable) {
